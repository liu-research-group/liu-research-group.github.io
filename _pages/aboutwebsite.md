...
If you would like to use this template for your own group, start from [Allan's Lab](https://github.com/allanlab/allanlab) &mdash; that is the original, and it comes with proper documentation.
